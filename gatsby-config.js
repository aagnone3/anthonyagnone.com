...
module.exports = {
  ...
  siteMetadata: {
    title: `Anthony Agnone`,
    author: `Anthony Agnone`,
    firstName: `Anthony`,
    lastName: `Agnone`,
    description: `Anthony Agnone's personal site`,
    occupation: `Machine Learning | Software Engineering | DevOps`,
    keywords: [`Anthony`, `Agnone`, `Personal`, `Blog`, `Resume`, `Projects`, `Work`],
    siteUrl:
